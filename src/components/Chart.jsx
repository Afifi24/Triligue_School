...
const Chart = () => {
  return (
    <section id='Academique'>
      ...
      <div className=' chartbg bg-lightYellow  '>
        <div className='flex flex-col lg:flex-row mt-4 lg:mt-0  items-center lg:justify-around'>
                 <div className='flex lg:flex flex-1 text-sm md:text-sm lg:text-lg 2xl:text-2xl flex-col gap-16 2xl:gap-32 p-6 2xl:mt-32 text-pimaryBlue font-semibold'>
