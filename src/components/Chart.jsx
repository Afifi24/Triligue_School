...
const Chart = () => {
  return (
    <section>
      ...
      <div className='lg:min-h-screen chartbg'>
        <div className='flex  items-center justify-around'>
                 <div className='flex flex-1 text-xs md:text-sm lg:text-lg 2xl:text-2xl flex-col gap-16 2xl:gap-32 p-6 2xl:mt-32 text-pimaryBlue font-semibold'>
              ...
              <img className='flex-1 w-[60%] ' src={heroChart} alt="" />
              <div className='flex flex-1  flex-col gap-16 p-6 mt-28 text-pimaryBlue text-xs md:text-sm lg:text-lg 2xl:text-2xl 2xl:gap-32 2xl:mt-64 font-semibold'>
                      <div className='lg:w-[400px] grid place-items-center'>
